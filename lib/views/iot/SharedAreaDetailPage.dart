...
/// IoT monitoring detail for a shared area — mirrors the classroom detail layout.
class SharedAreaDetailPage extends StatelessWidget {
  final SharedSpace space;
  final SensorReading? sensors;

  const SharedAreaDetailPage({super.key, required this.space, this.sensors});
  ...
  Widget _spaceInfoCard() {
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
          children: [
            _infoRow(Icons.groups_outlined, 'Capacidad', '${space.capacity} personas'),
